...
st.title('Web VR Code Generator - All Environments')
st.write('Click VR to go to VR space and explore all 20 A-Frame environments! 🌍')
...
choose3 = st.sidebar.selectbox("Choose Environment (20 presets):", Options3)
